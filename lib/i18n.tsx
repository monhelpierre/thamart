...
const pt: Dict = {
  ...
  termsNotice: "Ao entrar você concorda com os",
  ...
  maxPrice: "Máx",
  // Address step
  addressStep: "Endereço de entrega",
  cepLabel: "CEP",
  ...
  shippingCalcAtCheckout: "Varia por região — calculado no pagamento",
  pixLoading: "Gerando Pix...",
  // QR step
  awaitingPayment: "Aguardando confirmação do pagamento...",
  simulatePay: "Simular pagamento (teste)",
  // Confirmation
  ...
  orderDate: "Data",
  statusPendingPayment: "Aguardando",
  statusPaid: "Confirmado",
  ...
  closeModal: "Fechar",
  // Reviews
  leaveReview: "Avaliar produto",
  reviewTitle: "Sua avaliação",
  ratingLabel: "Nota",
  ...
  reviewsTitle2: "Avaliações dos clientes",
};
...
const fr: Dict = {
  ...
  signingIn: "Connexion...",
  termsNotice: "En vous connectant, vous acceptez",
  ...
  maxPrice: "Max",
  // Address step
  addressStep: "Adresse de livraison",
  cepLabel: "CEP",
  cepPlaceholder: "00000-000",
  cepLoading: "Recherche du CEP...",
  cepNotFound: "CEP introuvable",
  streetLabel: "Rue",
  numberLabel: "Numéro",
  ...
  shippingCalcAtCheckout: "Varie par région — calculé au paiement",
  pixLoading: "Génération du Pix...",
  // QR step
  awaitingPayment: "En attente de confirmation du paiement...",
  simulatePay: "Simuler le paiement (test)",
  // Confirmation
  viewOrder: "Suivre la commande",
  orderNumber: "Commande nº",
  // Order tracker
  myOrders: "Mes commandes",
  orderDate: "Date",
  statusPendingPayment: "En attente",
  statusPaid: "Confirmé",
  statusInProduction: "Production",
  ...
  closeModal: "Fermer",
  // Reviews
  leaveReview: "Évaluer le produit",
  ...
  reviewsTitle2: "Avis des clients",
};
...
const en: Dict = {
  ...
  termsNotice: "By signing in you agree to",
  ...
  maxPrice: "Max",
  // Address step
  addressStep: "Delivery address",
  cepLabel: "ZIP/CEP",
  cepPlaceholder: "00000-000",
  cepLoading: "Looking up CEP...",
  ...
  shippingCalcAtCheckout: "Varies by region — calculated at checkout",
  pixLoading: "Generating Pix...",
  // QR step
  ...
  addressPromptText: "Save your delivery address to speed up future purchases!",
  skipForNow: "Not now",

            ...
            <div className="mx-auto max-w-2xl">
                ...
                <div className="space-y-8 text-slate-700 dark:text-slate-300 leading-relaxed">
                    ...
                    <section>
                        ...
                        <p>Dúvidas sobre privacidade? Fale conosco pelo Instagram <a href="https://www.instagram.com/_thamart_" className="text-[#9B2D8F] hover:underline" target="_blank" rel="noopener noreferrer">@_thamart_</a>.</p>
                    </section>
                </div>
            </div>
        </main>
